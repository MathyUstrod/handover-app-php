<?php
    ...
    //action to be edited
    $action_to_edit = new Actions();
    $action = $action_to_edit -> getAction($id);
    $note = $assoc_handover -> getNote($action[0]["assocNoteID"]);
...
<div class="container">
    ...
    <form action="editAction.php" enctype="multipart/form-data" method="post">
        <input type="number" name="id" value="<?php echo $id; ?>" hidden>
        <div class="field">
            <label class="label" for="title">Title <span class="required">*</span> </label>
            <div class="control">
                <input class="input" name="title" type="text" placeholder="Title" value="<?php echo $action[0]["title"] ;?>">
            </div>
        </div>
            ...
            <div class="control is-expanded">
                ...
                <div class="select is-fullwidth">
                    <select name="assocNoteID">
                        <option value="<?php echo $action[0]["assocNoteID"].' - '.$note[0]["title"] ;?>"><?php echo $action[0]["assocNoteID"].' - '.$note[0]["title"] ;?></option> 
        ...
        <div class="field">
            ...
            <div class="control">
                <textarea class="textarea" name="description" placeholder="Outline action items here..."><?php echo $action[0]["description"] ;?></textarea>
            </div>
        </div>
                ...
                <div class="control is-expanded">
                    ...
                    <div class="select is-fullwidth">
                        ...
                        <select name="actionOwner">
                            <option value="<?php echo $action[0]["actionOwner"];?>"> <?php echo $action[0]["actionOwner"];?> </option>
                            <?php
        ...
        <div class="field is-grouped">
            ...
            <div class="control is-expanded">
                <input class="input" name="dueDate" type="date" value="<?php echo $action[0]["dueDate"];?>">
            </div>
            ...
            <div class="control is-expanded">
                ...
                <div class="select is-fullwidth">
                    <select name="status">
                        <option value="<?php echo $action[0]["status"];?>"><?php echo $action[0]["status"];?></option>
        ...
        <div class="field">
            ...
            <input type="text" name="oldattachment" id="" hidden value="<?php echo $action[0]["attachments"];?>">
            <div class="control is-expanded">
