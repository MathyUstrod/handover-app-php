<?php
    ...
    $memberDetails = new TeamMembers();

    $details = $memberDetails -> getTeamMemberDetails($memberID);
...
<head>
    ...
    <title>Edit Team Member | Handover App</title>
...
<div class="container">
    ...
    <div class="content">
        ...
        <p class="subtitle is-4">Edit Team Member</p>
        <hr>
        <div class="block"></div>
    </div>
...
<div class="container">
    ...
    <form action="editTeamMember.php" method="post">
        <input type="number" name="id" id="" hidden value="<?php echo $memberID;?>" >
        <div class="field">
            <label class="label" for="companyID">Company ID<span class="required">*</span></label>
            <div class="control">
                <input class="input" name="companyID" type="text" placeholder="Company ID" value="<?php echo $details[0]["companyID"];?>" >
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input type="text" class="input" name="name" placeholder="Name of new member" value="<?php echo $details[0]["name"];?>" >
            </div>
        </div>
        ...
        <div class="field is-grouped">
            ...
            <div class="control is-expanded">
                <div class="select is-fullwidth">
                    ...
                    <select name="section">
                        ...
                        <option value=""><?php echo $details[0]["section"];?></option>
            ...
            <div class="control is-expanded">
                ...
                <div class="control">
                    <input class="input" type="email" name="email"  required placeholder="someone@gmail.com" value="<?php echo $details[0]["email"];?>" >
                </div>
